          ...
          <div className="pageWrapper">
            <div className="formWrapper">
              <form onSubmit={handleSubmit}>
                <Field name="email" placeholder="Email" validate={validateRequired} />
                {touched.email && errors.email && <div className="error">{errors.email}</div>}
                <Field name="password" type="password" placeholder="Password" validate={validateRequired} />
                {touched.password && errors.password && <div className="error">{errors.password}</div>}
                <Field name="pizzaFruit" component="select" validate={validateSelect}>
                  <option value="">Favorite Pizza Topping</option>
                  <option value="watermelon">Watermelon</option>
                  <option value="pear">Pear</option>
                  <option value="mango">Mango</option>
                </Field>
                {touched.pizzaFruit && errors.pizzaFruit && <div className="error">{errors.pizzaFruit}</div>}
